...
- MiniMax H3 uses the installed official `h3-prompt-writing` Skill. Do not add a separate negative-prompt field, suffix, section, or project-specific word blacklist; keep the official section labels, media tags and timing grammar, write descriptive prose in English, and retain dialogue, lyrics, and visible text in their original language.
